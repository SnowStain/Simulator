...
public sealed class SimulationEntity
{
    ...
    public double PendingExperienceDisplay { get; set; }

    public int PendingLevelUpCount { get; set; }

    public Matrix4x4 RuntimeModelToSceneMatrix { get; set; } = Matrix4x4.Identity;

    public Matrix4x4 RuntimeModelToWorldMatrix { get; set; } = Matrix4x4.Identity;
    ...
    public double JumpCrouchTimerSec { get; set; }
    ...
    public string HeroAutoAimMode { get; set; } = "normal";
    ...
    public string AutoAimTargetKind { get; set; } = "vehicle_armor";
    ...
    public double AutoAimAimPointX { get; set; }

    public double AutoAimAimPointY { get; set; }

    public double AutoAimAimPointHeightM { get; set; }

    public double AutoAimObservedVelocityXMps { get; set; }

    public double AutoAimObservedVelocityYMps { get; set; }

    public double AutoAimObservedVelocityZMps { get; set; }

    public double AutoAimObservedAngularVelocityRadPerSec { get; set; }
    ...
    public double AutoAimLastLockChangeTimeSec { get; set; } = -999.0;

    public string? HeroLobPitchHoldLockKey { get; set; }
    ...
    internal AnnotatedEnergyMechanismDefinition? AnnotatedEnergyMechanism { get; set; }

    public IReadOnlyDictionary<string, IReadOnlyList<ArmorPlateTarget>>? RuntimeEnergyTargetsByTeam { get; set; }

    public double RuntimeEnergyTargetsGameTimeSec { get; set; } = double.NaN;

    public IReadOnlyDictionary<string, Matrix4x4>? RuntimeEnergyCompositeTransformsByTeam { get; set; }

    internal AnnotatedOutpostTeamDefinition? AnnotatedOutpost { get; set; }
    ...
    public double HeatLockInitialHeat { get; set; }
...
public sealed class SimulationTeamState
{
    ...
    public bool EnergyTestAlwaysAvailable { get; set; }

    public bool EnergyTestForceLarge { get; set; }
...
public sealed class SimulationWorldState
{
    ...
    public IDictionary<string, Matrix4x4> RuntimeModelTransforms { get; } =
