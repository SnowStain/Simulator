...
public sealed class TerrainEditorService
{
    ...
    {
        string path = _mapPresetService.ResolveMapPresetPath(layout, presetName);
        JsonObject root = _configurationService.LoadConfig(path);
    ...
    public void SavePresetDocument(MapPresetEditorSettings document)
    {
        ...
        map["map_type"] = document.TerrainSurface.MapType;
        ...
        _configurationService.SaveConfig(document.SourcePath, root);
    }
}
